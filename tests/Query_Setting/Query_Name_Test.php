...
/**
 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name
...
class Query_Name_Test extends TestCase {
	...
	/**
	 * @var \TWRP\Query_Generator\Query_Setting\Query_Name
	 */
	...
	/**
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::get_setting_name
	 */
	...
	/**
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::get_title
	 */
	...
	/**
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::setting_is_collapsed
	 */
	...
	/**
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::get_default_setting
	 */
	...
	/**
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::display_setting
	 */
	 ...
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::sanitize_setting
	 *
	 * @param mixed $value
	 */
	...
	/**
	 * @dataProvider sanitization_provider
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::get_submitted_sanitized_setting
	 *
	 * @param mixed $value
	 */
	 ...
	 * @covers \TWRP\Query_Generator\Query_Setting\Query_Name::add_query_arg
	 *
	 * @param mixed $setting
	 */
