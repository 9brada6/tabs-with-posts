...
/**
 * Class used to create a setting that will manage to display the views on an
 * Article Block.
 */
class Display_Views_Setting extends Artblock_Setting {
	...
	public function get_comments_setting_args() {
		$plugin_installed = ( Post_Views::get_plugin_to_use() === false ? false : true );
		...
		$after = _x( 'Display the views', 'backend', 'twrp' );
