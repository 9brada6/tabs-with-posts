...
/**
 * Class used to create a setting that will manage to display the date on an
 * artblock.
 */
class Display_Date_Setting extends Artblock_Setting {
	...
	public function display_setting() {
		...
		Checkbox_Control::display_setting( $id, $name, $this->current_setting, $this->get_display_date_setting_args() );
	}

	public function sanitize_setting() {
		return Checkbox_Control::sanitize_setting( $this->current_setting, $this->get_display_date_setting_args() );
	}
	...
	public function get_display_date_setting_args() {
		return array(
			...
			'value'   => '1',
			'after'   => _x( 'Display the date.', 'backend', 'twrp' ),
		);
	}
