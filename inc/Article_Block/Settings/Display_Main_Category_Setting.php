...
/**
 * Class used to create a setting that will manage to display the main category
 * on an Article Block.
 */
class Display_Main_Category_Setting extends Artblock_Setting {
	...
	public function get_comments_setting_args() {
		return array(
			...
			'value'   => '1',
			'after'   => _x( 'Display the main category.', 'backend', 'twrp' ),
		);
	}
