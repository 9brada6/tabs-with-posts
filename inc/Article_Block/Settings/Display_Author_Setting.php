...
class Display_Author_Setting extends Artblock_Setting {
	...
	public function display_setting() {
		...
		Checkbox_Control::display_setting( $id, $name, $this->current_setting, $this->get_display_author_setting_args() );
	}

	public function sanitize_setting() {
		return Checkbox_Control::sanitize_setting( $this->current_setting, $this->get_display_author_setting_args() );
	}
	 ...
	 * @return array
	 */
	protected function get_display_author_setting_args() {
		return array(
