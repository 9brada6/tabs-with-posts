...
/**
 * Class used to create a setting that will manage to display the rating on an
 * Article Block.
 */
class Display_Rating_Setting extends Artblock_Setting {
	...
	public function get_rating_setting_args() {
		...
		$after = _x( 'Display the rating', 'backend', 'twrp' );
